%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Calculation the solution of BVP without
%% taking into account reflection and refraction
%% at the interface
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
eps_iter = 1e-7;  % epsilon in the stopping criterion
num_iter = 0;
